...
import csv
import fundfees
# this a dictionary called fund_fees with key
#  the health fund ID and the data being a tuple of the consult fee
# and the unit fee for each fund.
import test_string_mod
# this file contains a string variable
